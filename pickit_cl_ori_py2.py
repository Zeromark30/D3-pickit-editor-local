...
def run(buildnumber=buildnumber, fourthree=fourthree, buildtype=buildtype):
    # FUNCTION DECLARATIONS */

    def get_page(buildnumber):
        while True:
            try:
...
def write_output(buildnumber=buildnumber, buildtype=buildtype, pickitList=pickitList)
    if buildtype == "full":
        with open(r'data\essentials.txt', 'r') as essentials:
